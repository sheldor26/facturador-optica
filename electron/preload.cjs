...
contextBridge.exposeInMainWorld("api", {
  ...
  revisarNumeracion: (recuperar) => ipcRenderer.invoke("facturas:revisarNumeracion", recuperar),
  ...
  verPresupuesto: (id) => ipcRenderer.invoke("presupuesto:ver", id),
  ...
  listarOrdenes: () => ipcRenderer.invoke("ordenes:listar"),
  facturarOrden: (clave, opciones) => ipcRenderer.invoke("orden:facturar", clave, opciones),
  descartarOrden: (clave, motivo) => ipcRenderer.invoke("orden:descartar", clave, motivo),
  pedidoDetalle: (id) => ipcRenderer.invoke("pedido:detalle", id),
  facturarPedido: (id, receptor, opciones) => ipcRenderer.invoke("pedido:facturar", id, receptor, opciones),
  ...
  gestionEstadoCred: () => ipcRenderer.invoke("gestion:estadoCred"),
  gestionGuardarCred: (c) => ipcRenderer.invoke("gestion:guardarCred", c),
