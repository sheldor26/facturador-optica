...
8. ~~`path.basename` en `guardarSetup` del logo (Importante #11) y tombstone para presupuestos y clientes borrados (Importante #8)~~ ✅ hecho (2026-08-05). Queda pendiente el mismo `path.basename` en la subida de fotos de Sancor (Importante #7).
